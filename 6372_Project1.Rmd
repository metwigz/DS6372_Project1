...
```{r}
#Custom Model----------------------------------------------------------
df.clean.train.cust <- lm(L_SalePrice ~ LotArea + Neighborhood + OverallQual + OverallCond + YearBuilt + GrLivArea + GarageCars + YearRemodAdd + BsmtFinSF1 + YearRemodAdd*OverallCond, data = df.clean.train) #to remove a row: df.clean.train[row.names(df.clean.train) != "1299",]
